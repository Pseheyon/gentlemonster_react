    ...
    return(
        <>
            <div className='main_item'>
                    ...
                    <img src='https://pseheyon.github.io/gentlemonster_react/img/main/main_item.png' alt=''/>
                    <Link to='/sub/sub01' ><Button01 className='main_btn'>more</Button01></Link>
                    <img className='gif' src='https://pseheyon.github.io/gentlemonster_react/img/main/symbol_f.gif' alt=''></img>
        ...
        <div className="main_outer main">
                    ...
                    <div className="product_wrap">
                        ...
                        <div className="product_img_wrap">
                            <ul className="sheet_sun">
                                    ...
                                    <li ><Link to='detail01'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/sun_02.png" alt="sun"/></Link>
                                        <div className="txt_product">
                                            <span>르01</span>
                                            <span>280,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail01'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/sun_03.png" alt="sun"/></Link>
                                        <div className="txt_product">
                                            <span>두다02</span>
                                            <span>280,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail01'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/sun_04.png" alt="sun"/></Link>
                                        <div className="txt_product">
                                            <span>베02</span>
                                            <span>440,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail01'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/sun_05.png" alt="sun"/></Link>
                                        <div className="txt_product">
                                            <span>레인 M01</span>
                                            <span>290,000</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail01'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/sun_06.png" alt="sun"/></Link>
                                        <div className="txt_product">
                                            <span>브레이드 M01</span>
                                            <span>430,000원</span>
                                        </div>
                        ...
                        <div className="product_img_wrap02">
                            <ul className="sheet_gla ">
                                    ...
                                    <li ><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_01.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>제니</span>
                                            <span>269,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_02.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>제프 01</span>
                                            <span>260,000원</span>
                                        </div>
                                    ...
                                    <li><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_03.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>알리오 X GD1</span>
                                            <span>310,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_04.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>에디 01</span>
                                            <span>249,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_05.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>알리오 C1</span>
                                            <span>310,000원</span>
                                        </div>
                                    ...
                                    <li ><Link to='detail02'><img src="https://pseheyon.github.io/gentlemonster_react/img/main/glass_06.jpg" alt="glass"/></Link>
                                        <div className="txt_product">
                                            <span>S.O.A M01</span>
                                            <span>360,000원</span>
                                        </div>
            ...
            <div className="banner_wrap">
                <img src="https://pseheyon.github.io/gentlemonster_react/img/main/bannerFront.png" alt=""/>
                <div>
