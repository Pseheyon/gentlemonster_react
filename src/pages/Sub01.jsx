...
export default function Sub01(){
    return(
        ...
        <Container className="sub01">
                ...
                data1.map((sub1, i)=>{
                    return(
                        <div  className={sub1.class} key={sub1.id}>
                            <Link to='/detail01'><img src={`https://pseheyon.github.io/gentlemonster_react/img/sub/sub01_${i+1}.png`} alt="" width="100%" height="auto" ></img></Link>
            ...
            <div className="img_big"><img src="'https://pseheyon.github.io/gentlemonster_react/img/sub/big02_long2.png" alt="" /></div>
        </Container></>
    )
